...
class SistemaHotDogCCS:
    ...
    def obtener_numero_valido(self, mensaje, tipo_esperado=int):
    ...
    def obtener_opcion_valida(self, mensaje, opciones_validas):
        ...
        while True:
            opcion = self.obtener_numero_valido(mensaje, int)
    ...
    def iniciar_principal(self):
        ...
        while True:
            ...
            opcion = self.obtener_opcion_valida("Seleccione una opción: ", [1, 2, 3, 4, 5, 6])
    ...
    def manejar_gestion_ingredientes(self):
        print("\n[Módulo 1: Gestión de Ingredientes]")
        self._gestor_ingredientes_ref.ver_lista_maestra_simple()
        # Aquí iría el sub-menú completo para añadir/eliminar/listar
        
    def manejar_gestion_inventario(self):
        print("\n[Módulo 2: Gestión de Inventario]")
        self._gestor_inventario_ref.ver_existencias()
        # Aquí iría el sub-menú completo para visualizar o actualizar existencias
        
    def manejar_gestion_menu(self):
        print("\n[Módulo 3: Gestión del Menú]")
        self._gestor_menu_ref.ver_lista_hotdogs()
